...
# ==============================================================================
VAR_THRESHOLD   <- 0.96      # cumulative variance for PC selection
...
# ==============================================================================
# SHARED PHASE: FPCA ON FUNCTIONAL QUANTILES (Monotone Rearrangement)
# ==============================================================================
...
# Teniamo solo i primi 180 minuti (le 3 ore più intense della giornata).
# Tagliamo via le restanti 21 ore di riposo che "ingannano" l'algoritmo.
matrix_smooth <- matrix_smooth[, 10:60] 
...
# ... il resto della SHARED PHASE rimane uguale ...
...
# ... DA QUI IN POI IL CODICE ESISTENTE (var_df, prcomp, K-Means, ecc.) RIMANE IDENTICO ...
